...
const electronApi: ContextBridgeApi = {
	invoke: {
		...
		// Last.fm Discover
		lastfmValidateUser: getInvoker('lastfmValidateUser'),
		lastfmGetMatches: getInvoker('lastfmGetMatches'),
		lastfmGetSyncState: getInvoker('lastfmGetSyncState'),
	},
	emit: {
		...
		// Last.fm Discover
		lastfmSync: getEmitter('lastfmSync'),
	},
	on: {
		...
		// Last.fm Discover
		lastfmSyncProgress: getListenerAdder('lastfmSyncProgress'),
	},
}
