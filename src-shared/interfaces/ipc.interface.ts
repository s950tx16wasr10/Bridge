...
import { LastfmSyncAction, LastfmSyncProgress, LastfmValidateResult, MatchQuery, MatchResult } from './lastfm.interface.js'
...
export interface IpcInvokeEvents {
	...
	lastfmGetSyncState: {
		input: void
		output: LastfmSyncProgress | null
	}
}
