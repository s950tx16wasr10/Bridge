...
export class SettingsService {
	...
	get lastfmUsername() {
		return this.settings.lastfmUsername
	}
	set lastfmUsername(value: string) {
		this._settings.update(s => ({ ...s!, lastfmUsername: value }))
		this.saveSettings()
	}
	...
	set lastfmApiKey(value: string) {
		this._settings.update(s => ({ ...s!, lastfmApiKey: value }))
		this.saveSettings()
	}
}
